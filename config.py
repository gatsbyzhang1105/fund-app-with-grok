...
STYLE_CFG = {
    'balanced': {'label': '平衡型', 'w': (0.50, 0.30, 0.20), 'buy': (10, 20, 35), 'sell': (90, 80, 65), 'dev': (4.0, 2.0, 1.0), 'th': (2.2, 0.8, -0.8, -2.2)},
    'growth': {'label': '成长科技型', 'w': (0.35, 0.35, 0.30), 'buy': (8, 18, 30), 'sell': (92, 82, 70), 'dev': (6.0, 3.5, 1.5), 'th': (2.4, 1.0, -1.0, -2.4)},
    'cyclical': {'label': '资源周期型', 'w': (0.25, 0.35, 0.40), 'buy': (12, 22, 35), 'sell': (88, 78, 65), 'dev': (7.0, 4.0, 2.0), 'th': (2.2, 0.8, -0.8, -2.2)},
    'defensive': {'label': '低波稳健型', 'w': (0.55, 0.30, 0.15), 'buy': (15, 25, 40), 'sell': (85, 75, 60), 'dev': (3.0, 1.8, 0.8), 'th': (2.0, 0.7, -0.7, -2.0)},
